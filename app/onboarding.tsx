      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            >
              <Text style={{ color: language === 'bn' ? 'white' : theme.colors.textPrimary }}>বাংলা</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              style={[styles.toggleBtn, { 
            ...
            >
              <Text style={{ color: language === 'en' ? 'white' : theme.colors.textPrimary }}>English</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            >
              ...
              <Text style={{ color: mode === 'dark' ? 'white' : theme.colors.textPrimary }}>{t('onboarding.dark')}</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              style={[styles.toggleBtn, { 
            ...
            >
              ...
              <Text style={{ color: mode === 'light' ? 'white' : theme.colors.textPrimary }}>{t('onboarding.light')}</Text>
            </TouchableOpacity>
          </View>
        </View>
